...
module.exports = {
  description:
    'Adds decorator transform packages and settings to the parent app',
  ...
  afterInstall() {
    ...
    let eslintrc =
      ...
      fs.readFileSync(eslintrcPath, { encoding: 'utf8' });
    ...
    let parserIndex =
      eslintrcLines && eslintrcLines.findIndex((line) => line.match(/parser:/));
    let rootIndex =
      eslintrcLines && eslintrcLines.findIndex((line) => line.match(/root:/));
