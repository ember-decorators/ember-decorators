const extendFromApplicationEntity = require('ember-data/lib/utilities/extend-from-application-entity');
const isModuleUnificationProject = require('ember-data/lib/utilities/module-unification')
